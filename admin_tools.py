...
import base_loader, utils, security
import logging
...
@base_loader.tds
class BanMod(base_loader.Module):
    ...
    @base_loader.group_admin_ban_users
    @base_loader.ratelimit
    ...
    @base_loader.group_admin_add_admins
    @base_loader.ratelimit
