...
@base_loader.tds
class GitaddMod(base_loader.Module):
    """Загружает файлы на репозиторий GitHub"""
    strings = {"name": "GitUpbase_loader",
    ...
    def __init__(self):
        self.config = base_loader.ModuleConfig("GH_TOKEN", "TOKEN", lambda m: self.strings("cfg_token", m),
